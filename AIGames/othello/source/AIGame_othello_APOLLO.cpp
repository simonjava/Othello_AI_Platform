#include <stdio.h>
int board[8][8] = {0},map[8][8] = {0},map1[8][8] = {0},map2[8][8] = {0},val[8][8] = {0},num[8][8] = {0};
int quan[8][8] = {1200, -1000,1000,-500 ,-500 ,1000,-1000,1200,
                  -1000,-1000 ,0   ,0    ,0    ,0   ,-1000,-1000,
                  1000 ,0     ,1000,1000 ,1000 ,1000,0    ,1000,
                  -500,0     ,1000,1000 ,1000 ,1000,0    ,-500,
                  -500,0     ,1000,1000 ,1000 ,1000,0    ,-500,
                  1000 ,0     ,1000,1000 ,1000 ,1000,0    ,1000,
                  -1000,-1000 ,0   ,0    ,0    ,0   ,-1000,-1000,
                  1200 , -1000,1000,-500,-500,1000,-1000,1200};
